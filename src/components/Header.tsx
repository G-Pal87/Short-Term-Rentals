  ...
  return (
    <header
      className={`sticky top-0 z-50 transition-all duration-300 ${
        scrolled
          ? "bg-white/95 backdrop-blur-md shadow-md border-b border-cream-dark/60"
          : "bg-white/80 backdrop-blur-sm border-b border-cream-dark/40"
      }`}
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          >
            <div className="w-8 h-8 rounded-lg bg-secondary flex items-center justify-center transition-all duration-300 group-hover:bg-primary group-hover:scale-105">
            ...
            <div className="flex flex-col leading-none">
              <span className="font-serif font-bold text-secondary text-base sm:text-lg group-hover:text-primary transition-colors tracking-tight">
                Mediterranean
              </span>
          ...
          {/* Mobile hamburger */}
          <button
            className="md:hidden p-2 rounded-xl text-gray-600 hover:bg-cream-dark transition-colors"
      ...
      >
        <div className="border-t border-cream-dark bg-white/98 backdrop-blur-md px-4 py-4 space-y-1">
          {navLinks.map((link) => (
            <Link
              key={link.href}
              href={link.href}
